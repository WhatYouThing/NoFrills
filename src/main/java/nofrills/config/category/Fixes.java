    ...
    public static ConfigCategory create(Config defaults, Config config) {
        return ConfigCategory.createBuilder()
                ...
                .option(Option.<Config.fixModes>createBuilder()
                        ...
                        .description(OptionDescription.of(Text.of("Changes sneaking to revert to the old eye height, and to remove the smaller hitbox mechanic. This option automatically disables itself on 1.21+ Skyblock islands, such as the Galatea.")))
                ...
                .option(Option.<Config.fixModes>createBuilder()
                        ...
                        .description(OptionDescription.of(Text.of("Prevent the modern swimming/crawling animation from activating. This option automatically disables itself on 1.21+ Skyblock islands, such as the Galatea.")))
