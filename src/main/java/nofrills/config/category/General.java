        ...
        return ConfigCategory.createBuilder()
                ...
                .group(OptionGroup.createBuilder()
                        ...
                        .option(Option.<Boolean>createBuilder()
                                ...
                                .build())
                        .option(Option.<Boolean>createBuilder()
                                .name(Text.of("Attribute Prices"))
                                .description(OptionDescription.of(Text.of("Adds the lowest available prices for attributes, and the attribute roll, to item tooltips.")))
                                .binding(false, () -> Config.pricingAttribute, value -> Config.pricingAttribute = value)
                                .controller(Config::booleanController)
                                .build())
                        .option(Option.<Boolean>createBuilder()
