...
public class WorldRenderEvent {
    ...
    public WorldRenderEvent(CameraRenderState camera, PoseStack matrices, LevelRenderState state) {
        this.camera = camera;
        this.matrices = matrices;
        this.state = state;
    }

    public void drawQuad(Vec3 first, Vec3 second, Vec3 third, Vec3 fourth, VertexConsumer consumer, RenderColor color) {
    ...
    public void drawLine(Vec3 start, Vec3 end, float width, VertexConsumer consumer, RenderColor color) {
        PoseStack.Pose entry = this.matrices.last();
        Vec3 camPos = this.camera.pos;
