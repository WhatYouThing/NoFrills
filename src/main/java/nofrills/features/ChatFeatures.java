...
public class ChatFeatures {
    private static final NoFrillsConfig.partyBehavior auto = NoFrillsConfig.partyBehavior.Automatic;
    private static final NoFrillsConfig.partyBehavior ignore = NoFrillsConfig.partyBehavior.Ignore;
    private static final NoFrillsConfig.partyBehavior disabled = NoFrillsConfig.partyBehavior.Disabled;
