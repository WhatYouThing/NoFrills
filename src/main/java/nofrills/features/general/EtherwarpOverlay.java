...
public class EtherwarpOverlay {
    ...
    public static final SettingColor colorCorrect = new SettingColor(new RenderColor(0, 255, 0, 127), "colorCorrect", instance.key());
    public static final SettingColor colorWrong = new SettingColor(new RenderColor(255, 0, 0, 127), "colorWrong", instance.key());
    ...
    public static void onRender(WorldRenderEvent event) {
        if (instance.isActive() && mc.player != null && !mc.player.isSubmergedInWater()) {
            ...
            if (dist > 0) {
                ...
                if (hitResult.getType() == HitResult.Type.BLOCK && hitResult instanceof BlockHitResult blockHitResult) {
                    ...
                    event.drawFilled(Box.enclosing(pos, pos), true, valid ? colorCorrect.value() : colorWrong.value());
                }
            }
        }
    }
