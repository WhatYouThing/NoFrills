...
public class Viewmodel {
    ...
    public static final SettingInt speed = new SettingInt(6, "speed", instance.key());
    public static final SettingBool custom = new SettingBool(false, "speed", instance.key());
    ...
    public static final SettingDouble scaleX = new SettingDouble(0.0, "scaleX", instance.key());
    public static final SettingDouble scaleY = new SettingDouble(0.0, "scaleY", instance.key());
    public static final SettingDouble scaleZ = new SettingDouble(0.0, "scaleZ", instance.key());
