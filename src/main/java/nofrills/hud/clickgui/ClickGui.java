        ...
        this.categories = Lists.newArrayList(
                new Category("General", List.of(
                        ...
                        new Module("Price Tooltips", PriceTooltips.instance, "Adds pricing information to item tooltips. Requires connectivity to the NoFrills API.", new Settings(List.of(
                                ...
                                new Settings.Toggle("Craft Cost", PriceTooltips.craftCost, "Tries to calculate the lowest raw and/or insta-buy craft cost of an item.\nRecipes you view using /recipe will be cached automatically to provide craft costs.")
                        ))),
                        ...
                        new Module("No Render", NoRender.instance, "Prevent various things from appearing.", new Settings(List.of(
                                ...
                                new Settings.EnumToggle<>("Health Bar", NoRender.healthBar, "Where the health bar shouldn't be shown.\n\nNowhere: Don't hide the health bar.\nOutside rift: Hide the healthbar everywhere except the Rift.\nEverywhere: Hide the health bar in all areas."),
                        ...
                        new Module("Viewmodel", Viewmodel.instance, "Easily customize the appearance of your held item.", new Settings(List.of(
                                ...
                                new Settings.Toggle("No Swing Reset", Viewmodel.noSwingReset, "Prevents the swing animation from getting cancelled mid-animation."),
                                ...
                                new Settings.SliderDouble("Swing X", 0, 2, 0.01, Viewmodel.swingX, "The X multiplier for the swing animation offset."),
                                new Settings.SliderDouble("Swing Y", 0, 2, 0.01, Viewmodel.swingY, "The Y multiplier for the swing animation offset."),
                                new Settings.SliderDouble("Swing Z", 0, 2, 0.01, Viewmodel.swingZ, "The Z multiplier for the swing animation offset.")
                        ))),
                        ...
                        new Module("Item Protection", ItemProtection.instance, "Prevents you from accidentally dropping, selling or salvaging your important items.", new Settings(List.of(
                                ...
                                new Settings.Toggle("Override Sound", ItemProtection.playOverrideSound, "Whether to play sound when override is activated/deactivated."),
                        ...
                        new Module("Info Tooltips", InfoTooltips.instance, "Adds various information about an item to its tooltip.", new Settings(List.of(
                                ...
                                new Settings.Toggle("Museum Donated", InfoTooltips.museum, "Displays the Museum category of the item (if applicable)."),
                ...
                new Category("Solvers", List.of(
                        ...
                        new Module("Foraging Beacon", BeaconTuningSolver.instance, "Solves the beacon tuning mini-game on foraging islands."),
                ...
                new Category("Dungeons", List.of(
                        ...
                        new Module("Leap Overlay", LeapOverlay.instance, "Renders a custom overlay in place of the Spirit Leap menu.", new Settings(List.of(
                                ...
                                new Settings.Keybind("Leap First Key", LeapOverlay.firstKey, "The keybind to leap to the first player on the overlay (left -> right order)."),
                                new Settings.Keybind("Leap Second Key", LeapOverlay.secondKey, "The keybind to leap to the second player on the overlay (left -> right order)."),
                                new Settings.Keybind("Leap Third Key", LeapOverlay.thirdKey, "The keybind to leap to the third player on the overlay (left -> right order)."),
                                new Settings.Keybind("Leap Fourth Key", LeapOverlay.fourthKey, "The keybind to leap to the fourth player on the overlay (left -> right order)."),
                        ...
                        new Module("Terminal Solvers", TerminalSolvers.instance, "Solves terminals and prevents wrong clicks in F7/M7. Also hides item tooltips in every terminal.", new Settings(List.of(
                                ...
                                new Settings.SliderInt("Throttle Ticks", 0, 10, 1, TerminalSolvers.throttleTicks, "Allows only a single click to go through until the specified amount of server ticks passes.\nHelps prevent your clicks from being rate limited if the server is lagging."),
                        ...
                        new Module("Shard Score Message", BonusScoreMessage.instance, "Sends a message when you gain bonus score from an attribute.", new Settings(List.of(
                                new Settings.Toggle("Send Prince", BonusScoreMessage.sendPrince, "Whether to send the Prince message."),
                                new Settings.TextInput("Prince Message", BonusScoreMessage.msgPrince, "The message to send when a Prince is killed."),
                                new Settings.Toggle("Send Bat", BonusScoreMessage.sendBat, "Whether to send the Bat message."),
                                new Settings.TextInput("Bat Message", BonusScoreMessage.msgBat, "The message to send when a Bat is killed.")
                        ))),
