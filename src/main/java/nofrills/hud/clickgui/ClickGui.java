...
public class ClickGui extends BaseOwoScreen<FlowLayout> {
    ...
    protected void build(FlowLayout root) {
        ...
        Category generalCategory = new Category("General", List.of(
                ...
                new Module("Ignore Background", Config.keys.ignoreBackground, "Disables slots that have items with empty names."),
                new Module("Middle Click Override", Config.keys.middleClickOverride, "Replaces left clicks with middle clicks in applicable GUI's, making navigation smoother."),
                new Module("Price Tooltips", Config.keys.fetchPricing, "Adds pricing information to item tooltips. Requires connectivity to the NoFrills API.", new Settings(List.of(
                ...
                new Module("Wardrobe Hotkeys", Config.keys.wardrobeHotkeys, "Adds number hotkeys (1-9) to the Skyblock Wardrobe.", new Settings(List.of(
                ...
                new Module("Chat Waypoints", Config.keys.wardrobeHotkeys, "Automatically creates waypoints for coordinates sent in Party/Global chat.", new Settings(List.of(
