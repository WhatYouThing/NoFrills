        ...
        this.categories = Lists.newArrayList(
                new Category("General", List.of(
                        ...
                        new Module("No Render", NoRender.instance, "Prevent various things from appearing.", new Settings(List.of(
                                ...
                                new Settings.Toggle("Armor Bar", NoRender.armorBar, "Hides the armor bar from your hotbar."),
                                new Settings.Toggle("Food Bar", NoRender.foodBar, "Hides the food bar from your hotbar."),
