...
public class TickTimer extends SimpleTextElement {
    public final Feature instance = new Feature("tickTimerElement");
    ...
    private final Identifier identifier = Identifier.of("nofrills", "tick-timer-element");

    public TickTimer(String text, double x, double y) {
        ...
        this.options.setTitle(Text.of("Tick Timer Element"));
    }
    ...
    public void draw(OwoUIDrawContext context, int mouseX, int mouseY, float partialTicks, float delta) {
        if (HudManager.isEditingHud()) {
            ...
            if (!instance.isActive() || !Utils.isInDungeons() || TickTimers.getTimerList().isEmpty()) {
                return;
            }
        }
        this.setText(TickTimers.getText());
